...
var upsertTemplate = function (templatePath, Parameters, StackName) {
  return __awaiter(void 0, void 0, void 0, function () {
    var TemplateBody,
      stackDetails,
      err_1,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 12:
          ...
          _loop_1 = function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 3:
                  if (
                    !DEFAULTS.waitForStatuses.includes(stackStatus) &&
                    stackOutput
                  ) {
                    replaceOutputs_1 = {}
                    ;(_a = stackOutput.Outputs) === null || _a === void 0
                      ? void 0
                      : _a.map(function (obj) {
                          if (obj.OutputKey) {
                  ...
                  return [
                    4 /*yield*/,
                    sleep(DEFAULTS.awsRetryWaitSeconds * 1000),
                  ]
                case 4:
                  _a.sent()
                  return [2 /*return*/]
          ...
          _b.label = 13
        case 13:
          if (!(DEFAULTS.timeoutSeconds * 1000 > Date.now() - time))
            return [3 /*break*/, 15]
...
var route53ZoneUpdate = function (zoneID, zoneFilePath) {
  return new Promise(function (resolve, rejects) {
    var cli53 = child_process_1.spawn('cli53', [
      'import',
      '--file',
      '' + zoneFilePath,
      '--replace',
    ...
    cli53.on('close', function (code) {
      return code === 0 ? resolve(code) : rejects(code)
    })
  })
}
...
var getCurrentAccountID = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, sts.getCallerIdentity().promise()]
        case 1:
          identity = _a.sent()
